...
Dim an8_header_version$
Dim an8_header_build$

Dim an8_description_text$

Dim an8_environment_grid_auto_grid
Dim an8_environment_grid_model_grid_spacing
Dim an8_environment_grid_scene_edit_grid_spacing
Dim an8_environment_grid_ground_grid_size

Dim an8_environment_framerate
Dim an8_environment_limitplayback



MAX_AN8_TEXTURES = 50

Dim an8_texture_name$[MAX_AN8_TEXTURES]
Dim an8_texture_invert[MAX_AN8_TEXTURES]
Dim an8_texture_cubemap[MAX_AN8_TEXTURES]
Dim file$[MAX_AN8_TEXTURES,6]



MAX_AN8_COLORS = 200

Dim an8_color_r[MAX_AN8_COLORS]
Dim an8_color_g[MAX_AN8_COLORS]
Dim an8_color_b[MAX_AN8_COLORS]


const AN8_BLEND_MODE_DECAL = 0
const AN8_BLEND_MODE_DARKEN = 1
const AN8_BLEND_MODE_LIGHTEN = 2

const AN8_ALPHA_MODE_NONE = 0
const AN8_ALPHA_MODE_LAYER = 1
const AN8_ALPHA_MODE_FINAL = 2

MAX_AN8_TEXTURE_PARAMS = 200

Dim an8_texture_param_blend_mode[MAX_AN8_TEXTURE_PARAMS]
Dim an8_texture_param_alpha_mode[MAX_AN8_TEXTURE_PARAMS]
Dim an8_texture_param_percent[MAX_AN8_TEXTURE_PARAMS]



MAX_AN8_SURFACE_PROPERTIES = 200

    Dim an8_surface_property_color[MAX_AN8_SURFACE_PROPERTIES] 'ID for color in an8_color_(r,g,b)
    Dim an8_surface_property_factor[MAX_AN8_SURFACE_PROPERTIES]
    Dim an8_surface_property_texturename$[MAX_AN8_SURFACE_PROPERTIES]
    Dim an8_surface_property_textureparams[MAX_AN8_SURFACE_PROPERTIES] 'ID in an8_texture_param_(blend_mode, alpha_mode, percent)
